...
public class CommandLine {
  ...
  SortArray sortAlg;
        ...
        while (true) {
            ...
            while (true) {
               ...
               while (true){
                   ...
                   switch (resFormat){
                       case 1: intermediateRes=false;break;
                       case 2: intermediateRes=true;break;
                   }
                   if(resFormat==3){
                       break;
                   }
    ...
    public void PrintRes(int sort){
        ...
        switch (sort){
            case 1: result=sortAlg.simpleSort(intermediateRes);break;
            case 2: result=sortAlg.EfficientSort(intermediateRes);break;
            case 3: result=sortAlg.Non_Comparison_Sort(intermediateRes);break;
//            case 4: sortAlg.
        }
        String msg="Final Sorted Result :";
        if(intermediateRes){
            msg="Intermediate Results :";
        }
